...
- **ADO:** use `work_list_team_iterations` to list recent iterations, then `wit_get_work_items_for_iteration` for each, filtering to Done/Closed state. Sum story points.
